...
# &, and 연산자: 좌향과 우향의 논리값이 모두 True일 경우에만 전체 결과를 True로 도출함
'''
a = 6
...
if 1 < a < 10:
    print('ok')
'''
|, or 연산자: 좌항과 우항의 논리값이 한 쪽만 True여도 전체 결과를 True로 도출
'''
...
'''
- C언어에서는 정수 0을 False로 해석하고, 0이 아닌 모든 정수를 True로 해석 (논리형 타입이 없어서)
  파이썬에서도 C의 논리해석을 그대로 적용 가능
'''
apple = 0
if not apple:
    print('사과가 하나도 없습니다')
